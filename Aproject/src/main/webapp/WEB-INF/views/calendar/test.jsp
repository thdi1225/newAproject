			...
			<div class="modal-content">
				...
				<div class="modal-body">
						<div class="col-md-12 mb-2">
							...
							<small>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="calendarType1" name="calendarType" value = "일반" checked>
									<label class="form-check-label" for="calendarType1" style="color:#f7507b">일반</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="calendarType2" name="calendarType" value = "회의">
									<label class="form-check-label" for="calendarType2" style="color:#18aae2">회의</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="calendarType3" name="calendarType" value = "행사">
									<label class="form-check-label" for="calendarType3" style="color:#caca53">행사</label>
								</div>
							</small>
						</div>
						<div class="col-md-12">
							...
							<div>
								<input class="form-control" type="text" id="calendarTitle" name="calendarTitle" maxlength="50">
								<small>
								<div id="text-info">
									최대 30자 이내 (특수문자 제외)
								</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="date" class="form-control"value="" id="calendarStartDay" name="calendarStartDay">
									<span class="input-group-addon"> ~ </span>
									<input type="date" class="form-control"value="" id="calendarEndDay" name="calendarEndDay">
								</div>
							</div>
						</div>	
						<div class="col-md-12">
						<div class="form-group">
							...
							<div class="input-group">
								<input type = "time" class="form-control" id="calendarStartTime" name="calendarStartTime" max="HH" min="mm" value="09:00">
								<span class="input-group-addon"> ~ </span>
								<input type = "time" class="form-control" id="calendarEndTime" name="calendarEndTime" max="HH" min="mm" value="10:00">
							</div>
							</div>
						</div>
						<div class="col-md-12">
...
//	 			$("#calendarStartDay").val(date.dateStr);
//	 			$("#calendarEndDay").val(date.dateStr);
//	 			$("#calendarInsertModal").modal("show");
//	 		},
